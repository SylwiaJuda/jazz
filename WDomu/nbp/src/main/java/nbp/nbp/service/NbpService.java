...
public class NbpService {
    ...
    public Double show(String startDate, String endDate) {
        ResponseEntity<Nbp> response = restTemplate.getForEntity("http://api.nbp.pl/api/exchangerates/rates/a/gbp/"+startDate+"/"+endDate+"/", Nbp.class);
